...
const IconList = React.lazy(() => import("./icon-list-f758c011.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-9b8a4678.mjs"));
...
//# sourceMappingURL=admin-routes-6a4db8d9.mjs.map
