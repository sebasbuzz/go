...
import React, { useState, Fragment, useEffect, forwardRef, useRef, useLayoutEffect, useMemo, Suspense, useContext, Children, isValidElement, cloneElement, useCallback, useImperativeHandle, lazy, memo } from "react";
import { F as FilterOperator, a as FilterControlType, c as createdAtFilter, b as updatedAtFilter, N as NameWithAvatar, C as ChipList, l as BanUserDialog, m as DatatableDataQueryKey, n as DataTablePage, o as DeleteSelectedItemsAction, p as DataTableAddItemButton, q as FormSwitch, I as InfoDialogTrigger, r as Accordion, s as AccordionItem, k as AddIcon, j as FormChipField, D as DeleteIcon, v as Switch, U as USER_MODEL, M as MoreVertIcon, w as ChipField, x as TabContext, T as Tabs, e as TabList, f as Tab, y as useNormalizedModels, z as DataTable, E as useDataTable, t as timestampFilter, g as FormNormalizedModelField, H as FormDatePicker, u as useTags, J as dateRangeValueToPayload, K as FormattedNumber, L as DateRangeIcon, O as FormattedDateTimeRange, P as useDateRangePickerState, Q as DateRangeComparePresets, R as DateRangeDialog, B as ButtonGroup, V as DateRangePresets, S as SearchReportTable, G as GlobalLoadingProgress, W as truncateString, X as stripTags, Y as onlineArticlesImg, i as CannedRepliesDatatablePage } from "./search-report-table-4f5b82dc.mjs";
...
function useCreateUser$1(form) {
  return useMutation({
    mutationFn: (form2) => createUser$1(form2),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: DatatableDataQueryKey("users") });
    }
  });
}
const createUser$1 = async (payload) => {
  const newPayload = { ...payload, roles: [3] };
  console.log("newPayload", newPayload);
  return apiClient.post("users", newPayload).then((r) => r.data);
};
const SaveHubstaffUser = (props) => {
  const { mutate, status, isError, isSuccess } = useCreateUser$1();
  const payload = {
    email: props.email,
  ...
  return /* @__PURE__ */ jsxs("div", { className: `border-1 rounded-lg py-4 px-8 mb-5 ${isSuccess && "bg-positive/focus"}`, children: [
    /* @__PURE__ */ jsxs("div", { className: `flex gap-8 mb-5 ${isError && "text-danger"}`, children: [
      /* @__PURE__ */ jsxs("span", { children: [
        props.email,
        " - ",
        props.hubstaff_user_id
      ] }),
      /* @__PURE__ */ jsx("span", { children: `- Password: ${props.password}` }),
      isSuccess && /* @__PURE__ */ jsx("span", { className: "text-positive", children: "✓" })
    ] }),
    !isSuccess && /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: `Add User${status === "pending" ? "..." : ""}`
      }
    )
  ] });
};
function SyncHubstaffUsersDialog({ data, setData }) {
  const { close } = useDialogContext();
  const [globalStatusSaveUser, setGlobalStatusSaveUser] = useState(false);
  return /* @__PURE__ */ jsxs(Dialog, { children: [
    /* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(Trans, { message: "Sync Hubstaff Users" }) }),
    /* @__PURE__ */ jsx(DialogBody, { children: (data == null ? void 0 : data.length) > 0 ? data.map((user) => /* @__PURE__ */ jsx(
      SaveHubstaffUser,
      {
        data,
        setData,
        hubstaff_user_id: user.id,
        globalStatusSaveUser,
        setGlobalStatusSaveUser,
        email: user.email,
        password: "buzzzcr!321"
      },
      user.id
    )) : "No new Hubstaff users found." }),
    /* @__PURE__ */ jsx(DialogFooter, { children: /* @__PURE__ */ jsx(Button, { onClick: () => close(), children: /* @__PURE__ */ jsx(Trans, { message: "Cancel" }) }) })
  ] });
}
const getHubstaffUser = async (accessToken, id) => {
...
const getHubstaffMembers = async (accessToken) => {
  try {
...
function fetchAccessToken() {
  return apiClient.get(`hubstaff-access-token`).then((response) => response.data);
}
const fetchCurrentUsers = async () => {
  var _a2, _b, _c;
  try {
    const accessToken = await fetchAccessToken();
    const currentUsers = ((_c = (_b = (_a2 = (await apiClient.get(`users-all`)).data) == null ? void 0 : _a2.pagination.data) == null ? void 0 : _b.map((user) => user.hubstaff_user_id)) == null ? void 0 : _c.filter((hubstaffUserId) => hubstaffUserId !== null)) || [];
    const hubsMembers = await getHubstaffMembers(accessToken.access_token);
    const clearCurrentUsers = hubsMembers.members.filter((member) => !currentUsers.includes(member.user_id));
    const hubsUsersPromises = clearCurrentUsers.map((user) => getHubstaffUser(accessToken.access_token, user.user_id));
...
function UserDatatable() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(
    DataTablePage,
    {
      ...
      actions: /* @__PURE__ */ jsx(Actions$a, { data, setData }),
...
function Actions$a({ data, setData }) {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(DialogTrigger, { type: "modal", children: [
      /* @__PURE__ */ jsx(DataTableAddItemButton, { onClick: async () => {
        const users = await fetchCurrentUsers();
        if (Array.isArray(users)) {
          setData(users);
        }
      }, children: /* @__PURE__ */ jsx(Trans, { message: "Sync Hubstaff Users" }) }),
      data && /* @__PURE__ */ jsx(SyncHubstaffUsersDialog, { data, setData })
    ] })
  ] });
}
...
const IconList = React.lazy(() => import("./icon-list-a4dec55e.mjs"));
...
function HubstaffTokenForm() {
  const [refreshToken, setRefreshToken] = useState("");
  const [status, setStatus] = useState(false);
  const { trans } = useTrans();
  const exchangeRefreshTokenForAccessToken = async (refreshToken2) => {
    const tokenEndpoint = "https://account.hubstaff.com/access_tokens";
    const requestBody = new URLSearchParams();
    requestBody.append("grant_type", "refresh_token");
    requestBody.append("refresh_token", refreshToken2);
    try {
      ...
      toast.danger(
        trans(
          message(err == null ? void 0 : err.error_description)
        )
      );
    }
  };
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-20 text-sm", children: [
      /* @__PURE__ */ jsx("label", { className: "block first-letter:capitalize text-left whitespace-nowrap text-sm mb-4", id: "refresh_token", htmlFor: "refresh_token", children: "Refresh Token" }),
      /* @__PURE__ */ jsx("div", { className: "isolate relative", children: /* @__PURE__ */ jsx(
        "input",
        {
          id: "refresh_token",
          name: "refresh_token",
      ...
      /* @__PURE__ */ jsx("div", { className: "text-muted pt-10 text-xs", id: "refresh_token", children: `The refresh token will generate an Access Token that will be used to make requests to Hubstaff. In case it doesn't work, generate another one!` }),
      /* @__PURE__ */ jsx("div", { className: "text-danger pt-10 text-xs", children: /* @__PURE__ */ jsx("b", { children: "*Do not generate tokens too frequently!" }) }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-6 pt-10 text-xs", children: [
        /* @__PURE__ */ jsx("b", { children: "*How to generate refresh tokens in Hubstaff" }),
        " ",
        /* @__PURE__ */ jsx(LearnMoreLink, { link: "https://www.notion.so/Refresh-Tokens-Hubstaff-a10dbf93cf9e4fc69fe451bc5da87aa9" })
      ] })
    ] }),
    /* @__PURE__ */ jsx(
      Button,
      {
        ...
        children: /* @__PURE__ */ jsx(Trans, { message: "Generate Access Token" })
      }
    )
  ] });
}
function HubstaffSettings() {
  return /* @__PURE__ */ jsxs("section", { children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-40", children: [
      /* @__PURE__ */ jsx("h2", { className: "mb-4 text-xl", children: "Hubstaff" }),
      /* @__PURE__ */ jsx("div", { className: "text-sm text-muted", children: "Configure Hubstaff settings" })
    ] }),
    /* @__PURE__ */ jsx(HubstaffTokenForm, {})
  ] });
}
  ...
  return /* @__PURE__ */ jsx(
    DataTablePage,
    {
      ...
      emptyStateMessage: /* @__PURE__ */ jsx(
        ...
        {
          image: teamSvg,
          title: /* @__PURE__ */ jsx(Trans, { message: "No teams have been created yet" }),
          filteringTitle: /* @__PURE__ */ jsx(Trans, { message: "No matching teams" })
        }
      )
    }
  );
...
const ReportsPage = React.lazy(() => import("./admin-report-page-26f85e28.mjs"));
    ...
    children: [
      ...
      // SETTINGS
      {
        ...
        children: [
          ...
          { path: "hubstaff", element: /* @__PURE__ */ jsx(HubstaffSettings, {}) },
...
//# sourceMappingURL=admin-routes-c7808b3c.mjs.map
