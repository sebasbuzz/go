...
const IconList = React.lazy(() => import("./icon-list-59322860.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-ef53ccdc.mjs"));
...
//# sourceMappingURL=admin-routes-2277916f.mjs.map
