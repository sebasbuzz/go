...
import { H as HcSearchBar, u as useSearchTermLogger } from "./hc-routes-3423b88d.mjs";
import { useRef, Fragment, useState } from "react";
import { a as useTickets, S as SendReplyButton, l as TicketHeaderDateFormat, m as TicketTypeRequestTag, f as TicketTagList, c as useTicketReplies, T as TicketReplyLayout, I as InfiniteScrollSentinel, u as useChangeTicketStatus, k as useCreateTicket } from "./use-create-ticket-b99ef2d8.mjs";
...
function Header({ ticket, onOpenEditor, editorIsOpen }) {
  return /* @__PURE__ */ jsxs("div", { className: "mb-44", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-12", children: [
      /* @__PURE__ */ jsx("div", { className: "mr-auto font-semibold max-md:hidden flex gap-4 items-center", children: /* @__PURE__ */ jsx(
        TicketTagList,
        {
          ticket,
          tagType: "category",
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          FormSelect,
          {
            ...
            selectionMode: "single",
            className: "mb-24",
            children: ticketRequestTypes.map((request_type) => /* @__PURE__ */ jsx(Item, { value: request_type.id, children: request_type.display_name || request_type.name }, request_type.id))
          }
        ),
        /* @__PURE__ */ jsx(
          FormTextField,
...
//# sourceMappingURL=hc-ticket-routes-061b500c.mjs.map
